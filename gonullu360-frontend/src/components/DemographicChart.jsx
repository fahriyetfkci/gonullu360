...
export default function DemographicChart({ data }) {
  ...
  return (
    ...
    >
      ...
      {chartData.length === 0 ? <div className="dashboard-empty-chart"><strong>Demografik veri bulunamadı</strong><span>Dağılım oluşturmak için gönüllü kaydı gerekiyor.</span></div> : <ResponsiveContainer width="100%" height={220}>
        <BarChart
          data={chartData}
          margin={{
            top: 10,
